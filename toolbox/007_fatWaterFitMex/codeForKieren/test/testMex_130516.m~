...
% Add to matlab path
BASEPATH = '/export/home/dhernando/work/projects/001_fatwater/code/006_fwtoolbox/fwtoolbox_v1_code/hernando/';
...
addpath /export/home/dhernando/work/projects/001_fatwater/code/007_fatWaterFitMex/ % This is where my Mex code is
...
algoParams.NUM_R2STARS = 5; % Numbre of R2* values for quantization
...
algoParams.SUBSAMPLE = 4; % Spatial subsampling for field map estimation (for speed, typically 2-4)
...
%% Recon -- graph cut for initial guess
...
%% Now do Least-Squares at each voxel using the output of graphcut as initial guess
tic
