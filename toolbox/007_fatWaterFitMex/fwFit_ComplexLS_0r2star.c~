...
int  createSignal_complex_0R2star_f(const gsl_vector * x, void *data, gsl_vector * f);
int  createSignal_complex_0R2star_df(const gsl_vector * x, void *data, gsl_matrix * J);
int  createSignal_complex_0R2star_fdf(const gsl_vector * x, void *data,gsl_vector * f, gsl_matrix * J);
...
/*   } */
  ...
  f.f = &createSignal_complex_0R2star_f;
  f.df = &createSignal_complex_0R2star_df;
  f.fdf = &createSignal_complex_0R2star_fdf;
  f.n = n;
  f.p = p;
  f.params = &d;
...
/*       mexPrintf("%s%f%s%d%s%d\n", "initwi1: ", initWi[0], ", kx : ", kx, ", ky :", ky);  */
      ...
      /* Do fitting */
      /*      dlevmar_dif(createSignal_magn_0R2star,initEst,curs,3,nte,MAX_ITER,NULL,NULL,work,covar,adata); */
...
int  createSignal_complex_0R2star_fdf(const gsl_vector * x, void *data,gsl_vector * f, gsl_matrix * J) {
  createSignal_complex_0R2star_f (x, data, f);
  createSignal_complex_0R2star_df (x, data, J);
  return GSL_SUCCESS;
}
